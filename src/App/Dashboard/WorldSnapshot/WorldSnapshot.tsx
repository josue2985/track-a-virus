  ...
  return (
    <>
      <div className={styles.snap__container}>
        <div
          className={`${styles['snap__box1']} ${styles['box']} ${styles['cases']}`}
        >
          <div className={styles.title__cases}>Total Casos</div>
          ...
          <div className={styles.pill__growth}>
            ...
            />
            <span className={styles.pill__label}>Promedio 3 días</span>
          </div>
        </div>
        <div
          className={`${styles['snap__box2']} ${styles['box']} ${styles['death']}`}
        >
          <div className={styles.title__death}>Total Fallecidos</div>
        ...
        >
          <div>
            <div className={styles.title__symptoms}>Síntomas</div>
            <div className={styles.subtitle__symptoms}>
              Conoce los sintomas del covid-19
            </div>
            <button className={styles.btn__symptons}>Leer Más</button>
