  ...
  return (
    <div>
      ...
      <nav className={styles.nav__container}>
        <NavLink to="/dashboard" activeClassName={styles.active} className={styles.menu}>
          <i>
          <svg
          ...
          <svg
            ...
            >
              <path
                ...
                d="M17.724 9.234a2.162 2.162 0 11-2.162-2.162 2.161 2.161 0 012.162 2.162M17.361 15.155v7.125a1.8 1.8 0 01-3.6 0v-7.125a1.8 1.8 0 113.6 0z"
              ></path>
              <path
               
                d="M15.563 0a15.563 15.563 0 1015.562 15.563A15.563 15.563 0 0015.563 0zm9.048 24.611a12.8 12.8 0 11-18.1-18.1 12.8 12.8 0 1118.1 18.1z"
              ></path>
              <path
